...
const SOCIAL_LINKS = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/fabiosanabria',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
    ...
    <section className="contact section" id="contact">
      <div className="container">
        ...
        >
          ...
          <p className="section-sub">
            Have a project in mind or just want to talk code and games?
          ...
          >
            <div className="contact__info-block pixel-border">
              ...
              <p className="contact__info-text">
                ...
                and interesting collaborations. Response time is usually
                within 24 hours.
              </p>
            </div>

            <div className="contact__socials">
              <p className="section-label" style={{ marginBottom: '0.75rem' }}>FIND ME AT</p>
      ...
      <div className="contact__footer">
        <p className="contact__footer-text">
          ...
          {' '}Designed &amp; built by Fabio Sanabria{' '}
          <span className="contact__footer-pixel">◆</span>
        </p>
      </div>
    </section>
